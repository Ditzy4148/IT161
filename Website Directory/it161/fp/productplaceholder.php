...
<html lang="en">
	...
	<body>
		...
		<div class="wrapper">
			...
			<!-- ◀ Page Title ▶ -->
			<h2 class="subheader">Product Name</h2>
			...
			<div class="product-placeholder">
				...
				<p>Placeholder for drop-down menus allowing customers to select quantity, variations (if applicable), and add to shopping cart</p>
			</div>
